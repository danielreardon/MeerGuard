...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--chanthresh", type=float, dest="chan_thresh", help="Channel threshold (in Median absolute deviation) [default = 7.0]", default=7.0)
    parser.add_argument("-s", "--subthresh", type=float, dest="subint_thresh", help="Subint threshold (in Median absolute deviation) [default = 7.0]", default=7.0)
